...
function selectProfile(name: string) {
  switch (name) {
    case 'standard':
      installConf.mapCheckedComponents((comp) => {
        if (!comp.value.installed && (comp.value.required || !comp.value.optional)) {
          comp.checked = true;
        }
        return comp;
      });
    ...
    case 'minimal':
      installConf.mapCheckedComponents((comp) => {
        if (!comp.value.required || comp.value.installed) {
          comp.checked = false;
        }
        return comp;
      });
      break;
    case 'custom':
      routerPush('/installer/customize_component');
      return;
    default:
      break;
  }
